...
class CustomerNotificationsPage extends StatelessWidget {
  const CustomerNotificationsPage({Key? key}) : super(key: key);
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: notificationData.containsKey('status') &&
                          notificationData['status'] == 'cancelled'
                      ? ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                          ...
                          style: Styles
                              .elevatedButtonStyle(), // Apply elevated button style
